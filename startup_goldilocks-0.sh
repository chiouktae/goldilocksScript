...
# license 변경
kubectl exec -it goldilocks-0 -n goldilocks -- /bin/bash << EOF
cp /home/sunje/goldilocks_data/goldilocks/goldilocks-0/conf/license /home/sunje/goldilocks_home/license/
EOF
